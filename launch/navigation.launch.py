...
def generate_launch_description():
    ...
    rviz_config_path = os.path.join(get_package_share_directory('elsabot_robot'), 'rviz', 'navigation.rviz')

    default_map_path = os.path.join(get_package_share_directory('elsabot_robot'), 'maps', f'{MAP_NAME}.yaml')
    ...
    nav2_bt_through_poses_xml_path = os.path.join(get_package_share_directory('elsabot_robot'), 'nav_bt', 'navigate_through_poses_w_replanning_and_recovery.xml')
